...
navToogle.addEventListener("click", () => {
  ...
  navToogle.classList.toggle("animated-toggle");
});
/*=============== REMOVE MENU MOBILE ===============*/
...
const linkAction = () => {
  ...
  navToogle.classList.remove("animate-toogle");
...
// Altura real del header + un margen de seguridad
const HEADER_OFFSET = (headerEl?.offsetHeight || 80) + 16;
...
scrollActive(); // marca correcto al cargar
  ...
  if (
    ...
    emailjs
      ...
      .then(
        ...
        (error) => {
          alert("OOPS! Algo ha ido mal...", error);
        }
      );
    contactName.value = "";
    contactEmail.value = "";
